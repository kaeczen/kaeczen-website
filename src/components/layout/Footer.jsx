...
export const Footer = () => {
  ...
  const socialLinks = [
    { name: 'LinkedIn', url: 'https://linkedin.com/company/kaeczen', icon: 'linkedin' },
    { name: 'GitHub', url: 'https://github.com/kaeczen', icon: 'github' },
    { name: 'YouTube', url: 'https://youtube.com/@kaeczen', icon: 'youtube' }
  ];
      ...
      <div className="container-custom py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            <Link to={prefix || '/'} className="inline-block mb-4">
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center text-sm text-gray-500">
          ...
          <p className="mt-1">{t('footer.registered')}</p>
        </div>
      </div>
    </footer>
  );
