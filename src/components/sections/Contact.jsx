...
export const Contact = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      const templateParams = {
        ...
        preferred_language: data.language === 'en' ? 'English' : 'Español'
      };
  ...
  return (
    <section className="section-gradient" id="contact">
            ...
            <div className="glass rounded-xl p-8 space-y-6">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <a href={`mailto:${t('contact.info.email')}`} className="text-white hover:text-primary transition-colors">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <span className="text-white">{t('contact.info.web')}</span>
                </div>
              </div>
              ...
              <div className="pt-6 border-t border-white/10">
                ...
                <div className="flex gap-4">
                  <a
                    href="https://linkedin.com/company/kaeczen"
                    target="_blank"
                  ...
                  <a
                    href="https://youtube.com/@kaeczen"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-10 h-10 rounded-lg bg-white/5 flex items-center justify-center text-gray-400 hover:text-white hover:bg-white/10 transition-colors"
                  >
